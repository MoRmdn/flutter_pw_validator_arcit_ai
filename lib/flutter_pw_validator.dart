...
class FlutterPwValidator extends StatefulWidget {
  final int minLength,
      ...
      numericCharCount,
      specialCharCount;
  final double spaceBetweenBarAndConditions;
  ...
  FlutterPwValidator(
      ...
      this.successIcon = const Icon(Icons.check, color: Colors.green),
      this.failureIcon = const Icon(Icons.close, color: Colors.red),
      this.spaceBetweenBarAndConditions = 10,
    ...
    return new Container(
      ...
      child: new Column(
        ...
        children: [
          ...
          SizedBox(height: widget.spaceBetweenBarAndConditions),
          widget.title,
          SizedBox(height: widget.spaceBetweenBarAndConditions),
          new Expanded(
            child: Padding(
